...
from typing import IO, TYPE_CHECKING, Any, Callable, ClassVar, Optional, Protocol
...
class ZipArchiveAdapter(ArchiveAdapter):
  ...
  def _add_entry(self, name: str, external_attr: int, mtime: int, data: bytes | str) -> None:
